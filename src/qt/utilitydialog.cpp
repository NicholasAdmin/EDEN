    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Eden") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  eden-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Eden in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 EDEN, 0.1 EDEN, 1 EDEN and 10 EDEN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://edenpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://edenpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Eden is shutting down...") + "<br /><br />" +
