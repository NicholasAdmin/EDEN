...
This mechanism has been integrated into Bitcore-Node-Eden which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/edenpay/insight-api-eden#web-socket-api](https://github.com/edenpay/insight-api-eden#web-socket-api)
* API: [https://github.com/edenpay/insight-api-eden#instantsend-transactions](https://github.com/edenpay/insight-api-eden#instantsend-transactions)
...
By default, the Eden daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Eden daemon:
