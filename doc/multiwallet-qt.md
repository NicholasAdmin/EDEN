...
Only requiring some minor changes is eden.cpp.
...
Changes to eden.cpp
----------------------
eden.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
