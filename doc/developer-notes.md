...
Eden is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 3595.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 3594 for connections and services them.
...
However, in open source software such as Eden, where everyone uses
...
pay attention to for reviewers of Eden code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Eden uses tinyformat, which is type safe. Leave them out to avoid confusion
